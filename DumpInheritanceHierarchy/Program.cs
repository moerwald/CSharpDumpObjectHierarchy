...
namespace DumpInheritanceHierarchy
{
    ...
    {
        public static IEnumerable<Type> GetBaseTypes(this Type type) => type.BaseType == null ? new Type[0] : Enumerable.Repeat(type.BaseType, 1).Concat(type.BaseType.GetBaseTypes());
    }
